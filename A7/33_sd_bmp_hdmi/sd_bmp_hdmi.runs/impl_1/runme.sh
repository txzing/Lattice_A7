...
HD_PWD='C:/Users/txzing/Desktop/1_FPGA_Design/1_Verilog_35T/33_sd_bmp_hdmi/sd_bmp_hdmi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sd_bmp_hdmi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sd_bmp_hdmi.tcl -notrace
