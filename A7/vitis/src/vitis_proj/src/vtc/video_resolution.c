...
vres_timing_t vres_resolutions[VIDEO_RESOLUTION_NO_BUTT] = {
  ...
  {"1920X960",  960,   10,   20,   10,    0, 1920,   20,   40,   20,    0 }, // VIDEO_RESOLUTION_1920X960
   ...
   { "CUSTOM1",1200,    5,    5,   10,    1, 1920,   20,   20,   40,    1 }, // VIDEO_RESOLUTION_CUSTOM1
   ...
   { "1920x2160_30P",  2160, 5, 5, 10,    1, 1920,   10,   10,   10,    1 }, //VIDEO_RESOLUTION_BAIDUSF
   { "VISTEON_2240_820",820,    5,    5,    20,    1, 2240,    20,    40,    20,    1 }, //VISTEON_2240_820
   { "VISTEON_1920_720",720,    5,    5,    20,    1, 1920,    20,    40,    20,    1 } //VISTEON_1920_720
};
