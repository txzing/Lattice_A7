...
HD_PWD='C:/Users/txzing/Desktop/test/vivado/vivado_proj/vivado_proj.runs/system_Reset_Delay_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_Reset_Delay_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_Reset_Delay_0_0.tcl
