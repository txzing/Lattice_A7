...
module system
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 uart_0_txen TRI_O" *) output [0:0]uart_0_txen_tri_o;

  wire Reset_Delay_0_rst_n_o;
  ...
  assign diff_clock_rtl_0_1_CLK_N = sys_clk_n;
  assign diff_clock_rtl_0_1_CLK_P = sys_clk_p;
  assign uart_0_txen_tri_o[0] = axi_gpio_0_GPIO_TRI_O;
  system_Reset_Delay_0_0 Reset_Delay_0
       (.clk(microblaze_0_Clk),
        .rst_n_o(Reset_Delay_0_rst_n_o));
  ...
  system_rst_clk_wiz_1_100M_0 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
        ...
        .ext_reset_in(Reset_Delay_0_rst_n_o),
